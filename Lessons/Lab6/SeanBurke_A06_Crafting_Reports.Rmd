...
```{r project.setup, message=FALSE, warning=FALSE, paged.print=FALSE}
#Import libraries
library(tidyverse)
library(lubridate)
library(here)
...
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, results='hide', fig.cap="Monthly Ozone Concentrations 2018", fig.height=5, fig.width=10}
Ozone_2018 <- epa_data %>%
  filter(Year == 2018)
  ggplot(Ozone_2018, aes(
    x = factor(Month, levels = 1:12, labels = month.abb),
    y = Ozone
  )) + 
  geom_boxplot() +
    labs(title = "Monthly Ozone Concentration (2018)",
         x = "Month",
...
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, results='hide', fig.cap="Monthly Ozone Concentrations 2019", fig.height=5, fig.width=10}
Ozone_2019 <- epa_data %>%
  filter(Year == 2019)
  ggplot(Ozone_2019, aes(
    x = factor(Month, levels = 1:12, labels = month.abb),
    y = Ozone
  )) + 
  geom_boxplot() +
    labs(title = "Monthly Ozone Concentraions (2019)",
         x = "Month",
         y = "Concentration ug/m^3")
...
I did not use AI in the completion of of this assignment.
Sean Burke
10/21/2025

## Git Repository
https://github.com/sean-burke4/EDE_Fall2025
